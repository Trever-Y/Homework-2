...
BP_dataframe_placebo$post_under_120 <- ifelse(BP_dataframe_placebo$post_bp < 120,
                                              "TRUE", "FALSE"
)
...
for (i in 1:nrow(list_bp$treatment)) {
  bp <- list_bp$treatment$post_bp[i] #simplify accessing each element of the list
...
for (i in 1:nrow(list_bp$placebo)) {
  bp2 <- list_bp$placebo$post_bp[i] #simplify accessing each element of the list
